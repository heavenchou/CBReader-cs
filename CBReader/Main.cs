...
window.onload=function(){{
  ...
  window.close();
        ...
        async void InitialWebView2()
        {
            ...
            CGlobalVal.ShareEnv = webView2Environment;  // 記錄起來給其它地方使用
        ...
        private void MainFunc_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            g.DrawString(tabPage.Text, tabFont, textBrush, tabControl.GetTabRect(e.Index), new StringFormat(stringFlags));
